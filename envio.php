<?php
    if(isset($_SESSION['idCliente'])){
      if(isset($_REQUEST['guardar'])){
        ...
        $queryRec = "INSERT INTO recibe(nombre, email, direccion, idCli) values ('$nombreRec', '$emailRec', '$direccionCli', $_SESSION[idCliente]) ON DUPLICATE KEY UPDATE 
            ...
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="nombreRec" id="nombreRec" class="form-control" value="<?php echo $rowRec['nombre']=$rowRec['nombre']??'';  ?>">

                    </div>

                    <div class="form-group">
                      <label for="">Email</label>
                      <input type="email" name="emailRec" id="emailRec" class="form-control" value="<?php echo $rowRec['email']=$rowRec['email']??''; 
 ?>">
                    </div>

                    <div class="form-group">
                      <label for="">Direccion</label>
                      <textarea  name="direccionRec" id="direccionRec" class="form-control" rows="3"><?php echo $rowRec['direccion']=$rowRec['direccion']??'';  
 ?></textarea>
                    </div>
       ...
       <p class="message">Debe <a href="login.php">loguearse</a> o <a href="registro.php">registrarse</a></p>
           </div>
