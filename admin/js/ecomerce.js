$(document).ready(function() {
    ...
    /* Cuando la pagina se recarga se mantiene los datos */
    $.ajax({
        type: "post",
        ...
        response.forEach(element=>{
            ...
            $("#tablaCarrito tbody").append(
                ...
                <tr>
                    ...
                    <button type="button" class="btn-xs btn-primary mas cantidad" data-id = "${element['id']}" data-tipo = "mas" >+</button>
                    ${element['cantidad']} 
                    <button type="button" class="btn-xs btn-danger menos cantidad" data-id = "${element['id']}" data-tipo = "menos" >-</button>
    ...
    /* Tabla para la pasarela sin botones que afecten el resultad */
    ...
    $("#agregarCarrito").click(function(e) {
        ...
        console.log(id+ "-" + nombre + "-" + web_path + "-" + cantidad + "-" + precio);
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        ${element['nombre']}
                                        <span class="float-right text-sm text-primary"><i class="fas fa-aye"></i></span>
                                    </h3>
