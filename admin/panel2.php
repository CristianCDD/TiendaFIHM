<?php
session_start();
session_regenerate_id(true); //Generamos nueva sesion (codigo) en cada actualizacion y borramos las anteriores sesiones
...
if (isset($_SESSION['id']) == false) { // isset verifica si se ingresa un
  header("location: index.php");
}
  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <a class="nav-link text-danger" title="Cerrar sesion" href="panel.php?modulo=&sesion=cerrar">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="panel.php?modulo=estadisticas" class="nav-link echo <?php echo ($modulo == "estadisticas" || $modulo == "") ? " active " : " "; ?>">
    ...
    } else  if ($modulo == 'usuarios' || $modulo == "") {
      include_once("usuarios.php");
    } else  if ($modulo == 'productos' || $modulo == "") {
      include_once("productos.php");
    } else  if ($modulo == 'ventas' || $modulo == "") {
      include_once("ventas.php");
    } else  if ($modulo == 'crearUsuario' || $modulo == "") {
      include_once("crearUsuario.php");
    } else  if ($modulo == 'editarUsuario' || $modulo == "") {
  ...
  $(function () {
    ...
    $('#tablaProductos').DataTable( {
        ...
        columns: [
            ...
            {
            data: 'files',
            render: d => d.length ? `${d.length} imagen(es)` : 'No hay images',
            title: 'Imagen'
        }
        ...
        select: true,
        buttons: [
            { extend: "create", editor: editor, text: "Agregar" },
